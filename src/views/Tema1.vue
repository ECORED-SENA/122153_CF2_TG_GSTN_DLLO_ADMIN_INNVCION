...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center 
      .col-md-8.col-lg-5.col-xl-4.mb-4
    ...
    .row.justify-content-center.mb-5
      .col-md-8.col-lg-10
        figure
          img(src='@/assets/curso/temas/tema1/img-6.svg', alt='Cuadro comparativo donde se exponen los usuarios internos como: socios, directivos, colaboradores y usuarios externos como: accionistas y acreedores, el Estado, proveedores, competencia, clientes y público en general.')
      ...
      .col-lg-12
        .row.justify-content-center
          ...
          .col-lg-8       
            ...
            AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--azul fnd-5")          
