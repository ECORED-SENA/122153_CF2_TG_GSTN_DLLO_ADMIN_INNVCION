    ...
    .row.justify-content-center
      .col-md-10.col-lg-8
        .titulo-sexto.color-acento-contenido
          p.mb-0 #[b Figura 1.] Etapas del proceso administrativo
        figure
            img(src='@/assets/curso/temas/tema3/img-1.svg', alt='En la siguiente imagen se puede observar las etapas del proceso administrativo, estas son: 1. Planeación: ¿qué se quiere lograr? 2. Organización: ¿cómo y con qué elementos se logrará? 3. Dirección: evidenciar lo que se haga. 4. Control: evaluar: ¿cómo se realizó?')
